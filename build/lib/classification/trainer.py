def build_trainer(opt, device_id, model, fields,
    ...
    """
    Simplify `Trainer` creation based on user `opt`
    Args:
        opt (:obj:`Namespace`): user options 
        model (:obj:`classification.model`): the model to train
        optim (:obj:`classification.Optimizer`): optimizer used during training
        model_saver(:obj:`classification.models.ModelSaverBase`): the utility object
